...
<style lang="stylus">
  ...
  .shopcart .content .content-left .logo-wrapper .logo &.active {
    background: #0d26308a;
  }
  ...
  .shopcart .content .content-left .logo-wrapper .logo .icon-shopping_cart &.active {
    color: #fff;
  }
  ...
  .shopcart .content .content-right &.active {
    background: #00b43c;
    color: #fff;
  }
