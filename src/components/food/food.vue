    ...
    <div v-show="foodShow" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect @onlyContentChange="onlyContentChange" @typeChange="typeChange" :select-type="selectType"
...
<style lang="stylus">
  ...
  .food .food-content .image-wrapper {
    position: relative;
    width: 100%;
    height: 0;
    padding-top: 100%;
  ...
  .food-content .image-wrapper .img {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .food-content .image-wrapper .back {
    position: absolute;
    top: 10px;
    left: 0;
  }

  .image-wrapper .back .icon-arrow_lift {
    display: block;
    padding: 10px;
    font-size: 20px;
    color: #fff;
  ...
  .food-content .content .buy &.buyFade-leave-active,
  &.buyFade-enter {
    opacity: 0;
  }
